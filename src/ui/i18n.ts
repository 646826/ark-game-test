...
export class I18n {
  ...
  public constructor(language = detectLanguage()) { this.language = language; }
  public t(key: TranslationKey, params: Params = {}): string {
  ...
  public number(value: number): string { return new Intl.NumberFormat(this.language).format(value); }
...
export function detectLanguage(): Language {
  ...
  return (['en','es','fr','de','it'] as const).includes(code as Language) ? code as Language : 'en';
}
export function isLanguage(value: string): value is Language { return ['en','es','fr','de','it'].includes(value); }
