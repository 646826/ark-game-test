...
export class ConservatoryRenderer {
    ...
    #premiumSpritesForPuzzle(puzzle) {
        const keys = new Set(['coupler', 'leak', 'lock', 'mechanism', 'source', 'tile-base']);
        for (const tile of puzzle.tiles) {
    ...
    #drawSource(projected, center, theme, time) {
        ...
        if (premiumSource) {
            ...
            context.drawImage(premiumSource, center.x - premiumSize / 2, baseY - premiumSize * 0.80, premiumSize, premiumSize);
        }
        else {
